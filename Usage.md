...
**Note:** Do not edit this file directly.  It is generated by `emacs-preload export-usage`.
...
--init-hook PROG | User hook. Called by `init` with the link directory as argument. Ignored if empty string (default '')
